<template>
  <div class="login-container">
    <!-- 在el表单中需要加入 model 绑定值 和 rules 规则 -->
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <!-- el-form-item 中 需要绑定当前输入框对应的字段 -->
      <el-form-item prop="username">
        <span class="svg-container">
          <svg-icon icon-class="user" />
        </span>
        <!-- 在输入框中 需要 绑定v-model 来双向绑定数据 -->
      ...
      <el-button class="login-btn" :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleLogin">Login</el-button>
